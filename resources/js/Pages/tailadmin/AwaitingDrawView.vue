...
import DrawChat from '@/Components/draw/WaitingDrawPage/DrawChat.vue';

const pageTitle = ref('Group Page - Awaiting Draw');
</script>
  ...
  >
    <div class="w-full">
        <div class="md:flex w-full">
            <ul class="w-2/12 flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                <li>
            ...
            <div class="w-10/12 p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg">
                <DrawChat />
            </div>
        </div>
    </div>
