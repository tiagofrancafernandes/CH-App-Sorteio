      ...
      },
      {
        ...
        children: [
            ...
            },
            {
                ...
                label: 'Awaiting Draw',
                href: '/awaiting-draw',
                href: route('tailadmin_view', 'awaiting-draw'),
                active: route().current('tailadmin_view', '/awaiting-draw'),
            },
            {
                label: 'Form Elements',
            ...
            },
            {
                label: 'DemoPageView',
                href: '/DemoPageView',
                href: route('tailadmin_view', 'DemoPageView'),
                active: route().current('tailadmin_view', '/DemoPageView'),
            },
            {
                label: 'Form Layout',
...
<template>
    <aside
        class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-gray-900 lg:static lg:translate-x-0"
        :class="{
